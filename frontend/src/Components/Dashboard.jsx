      ...
      <div className="flex flex-row  ">
        <Link to="/add-task">
          <div className="w-[400px] h-48  border-purple-300 border-2 ml-72 -mt-[440px] rounded-2xl">
            <div className="flex flex-row">
              ...
              <p className="text-3xl text-green-500 p-5 -ml-6">
                {" "}
                <IoMdAddCircleOutline />{" "}
              </p>
            </div>
            <p className="p-2 text-gray-600 ">
              Productivity starts with a single step. Add your task and begin
              your journey.
            </p>
          </div>
        </Link>
        <Link to="/my-todo-lists">
          <div className="w-[400px] h-48  border-purple-300 border-2 ml-28  -mt-[440px] rounded-2xl">
            ...
            <p className="p-2  text-gray-600">
              Comprehensive and organized list of all the tasks, goals, and
              responsibilities.
            </p>
          </div>
        </Link>
